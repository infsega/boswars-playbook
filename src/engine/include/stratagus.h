...
#ifdef DEBUG
#define STRATAGUS_LIB_PATH  "shared/misc/boswars/assets"      /// Where to find the data files
#else
#define STRATAGUS_LIB_PATH  "app/native/assets"      /// Where to find the data files
#endif
#endif
